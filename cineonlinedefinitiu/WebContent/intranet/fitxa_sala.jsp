			...
			<div id="caixa_pelicules">			
				<%
					...
					if (obj != null)
					{
						...
						<br /><br />
						número butaques
						<input type="Text" name="numButaques" class="caixa_text" value="<%= obj.getNumButaques() %>" maxlength="4" />
						<br /><br />
						número butaques operatives
						<input type="Text" name="numOperatives" class="caixa_text" value="<%= obj.numButaquesOperatives() %>" maxlength="4" />
						<br /><br />
						columnes malla
