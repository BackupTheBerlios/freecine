...
<jsp:include page="esquelet_adm/header.jsp"/>
	...
	<div id="center">
		...
		<br /><br />
		<span class="txt">	
				<form name="frmnou" action="GestioUsuarisServlet" method="post">
					<input type="Hidden" name="accio" value="nou usuari" />
					<input type="Submit" name="opcio_menu" class="boto_enllac" value="nou usuari" />
				</form>			
				<% 
