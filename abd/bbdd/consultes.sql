...
SELECT client.nif AS "DNI", client.nom AS "Nom",client.cognom1 AS "1r Cognom",unitat.id_unitat AS "Id Unitat", producte.descr AS "DescripciÛn", producte.marca AS "Marca", producte.model AS "Model", CURRENT_DATE AS "Data Actual", factura.data AS "Dia Llogat"
FROM client,producte,unitat,linia_factura,factura
WHERE   producte.id_prod = unitat.id_producte
