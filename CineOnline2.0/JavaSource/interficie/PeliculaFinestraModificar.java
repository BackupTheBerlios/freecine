 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PeliculaFinestraModificar implements ActionListener, WindowListener{
	...
	public PeliculaFinestraModificar(JFrame jfFinestraPrincipal, ControladorSalas controladorSalas, Sala sala){
		titol="Afegir Sala";
