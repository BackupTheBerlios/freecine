 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SalaFinestraInserir implements ActionListener, WindowListener{
	...
	public SalaFinestraInserir(JFrame jfFinestraPrincipal, ControladorSalas controladorSalas, Vector sales){
		titol="Afegir Sala";
