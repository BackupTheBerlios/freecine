 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SessioFinestraInserir implements ActionListener, WindowListener{
	...
	public SessioFinestraInserir(JFrame jfFinestraPrincipal, ControladorSalas controladorSalas, Vector sales){
		titol="Afegir Sala";
	...
	public void obrirFinestra(ControladorSalas controladorSalas, Vector sales){
		this.controladorSalas= controladorSalas;
		this.sales = sales;
	...
	private void afegirSala(){
		...
		controladorSalas.afegirSala(sala);
		//sales.add(sala);
