 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SessioFinestraModificar implements ActionListener, WindowListener{
	...
	public SessioFinestraModificar(JFrame jfFinestraPrincipal, ControladorSalas controladorSalas, Sala sala){
		titol="Afegir Sala";
