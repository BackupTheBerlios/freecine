...
(SELECT butaca.id, butaca.num_fila, butaca.num_columna, butaca.operativa, TRUE AS comprada_reservada
...
UNION
(SELECT butaca.id, butaca.num_fila, butaca.num_columna, butaca.operativa, FALSE AS comprada_reservada
FROM butaca
WHERE butaca.id_sala = sala.id
AND sala.id=sessio.id_sala
AND sessio.id = 1
